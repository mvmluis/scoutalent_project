...
<style>
    /* === Sidebar fixa, centrada e instantânea === */
    /* === Sidebar fixa, centrada e instantânea === */
    #sidenav-main {
        width: 260px;
        ...
        /* ⚡ torna-a visível imediatamente */
        opacity: 1;
        transition: none;
    }

    /* Se quiseres manter um pequeno fade só para suavizar */
    body.loaded #sidenav-main {
        transition: opacity .15s ease;
        opacity: 1;
    }

    /* 🔹 Margem lateral para o conteúdo */
    .main-content,
    .countries-container {
        margin-left: 300px; /* 260 + 40 */
        padding-top: 40px;
        transition: none;
    }
    ...
    @media (max-width: 1199px) {
        ...
        #sidenav-main.active { transform: translateX(0); }
...
<script>
    (function() {
        ...
        // ⚡ Torna a sidebar visível logo que o HTML/CSS estão prontos
