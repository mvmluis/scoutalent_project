...
<style>
    ...
    /* Garante que o conteúdo principal respeita o espaço lateral */
    .main-content {
        margin-left: 320px; /* espaço para a sidebar */
        padding: 20px;
    }

    /* 🍔 Mobile (modo deslizante mantido) */
    ...
    /* Mantém o estilo anterior de títulos, links e botões */
