...
<style>
    /* === 🟥 Sidebar centrada e elegante (sem sobreposição) === */
    #sidenav-main {
        width: var(--sidebar-w, 260px);
        background-color: #d60c0c !important;
        color: #fff;
        border-radius: 18px;
        position: absolute; /* era fixed → agora não cobre o conteúdo */
        top: 50%;
        left: 20px;
    ...
    /* 🧱 Garante espaço para o conteúdo à direita */
    .main-content {
        margin-left: 320px; /* reserva espaço lateral */
        padding: 20px;
    }
