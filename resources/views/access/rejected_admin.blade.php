...
<head>
    ...
    <title>Pedido Rejeitado — ScoutTalent</title>
...
<div class="card">
    ...
    <p>O pedido de acesso associado ao email <strong>{{ $req->email }}</strong> foi rejeitado.</p>
    <p>O utilizador foi notificado automaticamente por email.</p>
